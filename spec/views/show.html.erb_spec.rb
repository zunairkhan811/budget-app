...
#   let(:user1) { User.create(name: 'John Doe', email: 'john@example.com', password: 'password', password_confirmation: 'password') }
#   let!(:group1) { Group.create(name: 'Delicious Group', icon: 'icon_url_1', user: user1) }
#   let!(:food1) { Food.create(name: 'Tasty Food 1', amount: 20.5, author: user1, group_id: group1) }
...
#     expect(page).to have_content('11 January 2024') 
